...
class HomeFilmAdapter(
        ...
        filmView: IFilmView)
    : IRecyclerViewAdapter<HomeFilmAdapter.ViewHolder>(filmView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return HomeFilmAdapter.ViewHolder(view, mImageWidth)
    }
    ...
    class ViewHolder(mItemView: View, wid: Int?) : RecyclerView.ViewHolder(mItemView) {
        ...
        fun setTagItem(filmTag: DouBanV2.FilmTagType, index: Int) {
            ...
            cardview.onClick { showTagFilmList(DouBanV2.getTagString(filmTag), "movie") }
